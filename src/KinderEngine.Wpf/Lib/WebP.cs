...
namespace KinderEngine.Wpf.Lib
{
    /////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    public sealed class WebP : IDisposable
    {
        ...
        public BitmapSource Load(string pathFileName)
        {
            try
            {
        ...
        /// <returns>Bitmap with the WebP image</returns>
        public BitmapSource Decode(byte[] rawWebP)
        {
            Bitmap bmp = null;
            ...
            try
            {
                ...
                return System.Windows.Interop.Imaging.CreateBitmapSourceFromHBitmap(
                    ...
                    BitmapSizeOptions.FromWidthAndHeight(imgWidth, imgHeight));
            }
            catch (Exception ex) { throw new Exception(ex.Message + "\r\nIn WebP.Decode"); }
            finally
            {
